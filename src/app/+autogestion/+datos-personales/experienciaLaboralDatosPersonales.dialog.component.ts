...
export class ExperienciaLaboralDatosPersonalesDialogFormComponent extends ComponentBase{
  ...
  validarRequerido():boolean{
    ...
    if( this.fechaInicio != undefined  && this.fechaInicio != null && this.fechaInicio.length<10){
      $('#fechaInicioExperiencia').parent().addClass('state-error').removeClass('state-success');
      validacion = true;
    }

    if(this.fechaFin != undefined  && this.fechaFin != null && this.fechaFin.length>0 && this.fechaFin.length<10){
      $('#fechaFinExperiencia').parent().addClass('state-error').removeClass('state-success');
      validacion = true;
    }
