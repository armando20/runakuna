            ...
            <div class="smart-form" style="width: 900px;">
               ...
               <div class="row">
                ...
                <section class="col col-md-6">
                 ...
                 <section class="col col-md-6">
                  ...
                  <label class="input"> 
                        <kendo-dropdownlist id="tipoDocumentoDependiente" [data]="tiposDocumento" [(value)]="tipoDocumentoDependiente" [valuePrimitive]="true" [defaultItem]="defaultItem" [textField]="'nombre'" [valueField]="'codigo'" style="width: 100%;"><ng-template kendoDropDownListNoDataTemplate></ng-template></kendo-dropdownlist>														
                  </label>
                 </section>
             ...
             <div class="row">                   
                <section class="col col-md-6">
                  ...
                  <label class="input"> 
                        <kendo-dropdownlist id="relacionDependiente" [data]="relacionesDependiente" [(value)]="relacionDependiente" [valuePrimitive]="true" [defaultItem]="defaultItem" [textField]="'nombre'" [valueField]="'codigo'" style="width: 100%;"><ng-template kendoDropDownListNoDataTemplate></ng-template></kendo-dropdownlist>														
                  </label>
                 </section>
                 <section class="col col-md-6">
