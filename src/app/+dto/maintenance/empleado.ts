...
export class Empleado extends AuditingEntity{
     ...
     constructor(
         ...
         public distritoNacimientoString?:string,
         ...
         public distritoDomicilioString?:string,
         ...
         public cusppNumero?:string,

         public nombreCompletoEmpleado?:string,

         public idPaisNacimiento?: number,
         public idDepartamentoNacimiento?: number,
         public idProvinciaNacimiento?: number,
         public idDistritoNacimiento?: number,

         public idPaisDomicilio?: number,
         public idDepartamentoDomicilio?: number,
         public idProvinciaDomicilio?: number,
         public idDistritoDomicilio?: number,

         public publicarTelefonoCasa:boolean = true,
         public publicarTelefonoPersonal:boolean = true,
         public publicarTelefonoAdicional:boolean = true,
         public publicarEmailPersonal:boolean = true,
         public categoriaEmpleado?:string,
         public categoriaEmpleadoString?:string,
