...
export class RolService{
    ...
    buscarRolEmpleado(busquedaRol: RolFilter){
        ...
        return this.backendService.AuthRequest(RequestTypes.post, urlOptions,JSON.stringify(busquedaRol))
    ...
    obtenerRolById(idRol: any) {
        ...
        return this.backendService.AuthRequest(RequestTypes.post, urlOptions,JSON.stringify(idRol))
            .map(res => <Rol> res)
            .catch(err=> this.backendService.handleError(err));
    ...
    updateAutorizacion(accion: Accion){
        ...
        return this.backendService.AuthRequest(RequestTypes.post, urlOptions,JSON.stringify(accion))
            .map(res => <NotificacionResult> res)
            .catch(err=> this.backendService.handleError(err));
    }
    ...
    guardarRol(rol: Rol){
        ...
        let urlOptions: IUrlOptions = <IUrlOptions>{};
        urlOptions.restOfUrl = '/api/rol/registrarRolAccion';
        return this.backendService.AuthRequest(RequestTypes.post, urlOptions,JSON.stringify(rol))
            .map(res => <NotificacionResult> res)
            .catch(err=> this.backendService.handleError(err));
    }
